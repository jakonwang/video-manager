...
<div class="max-w-2xl mx-auto">
    <div class="glass-effect rounded-xl p-6">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('admin.edit_user') }}</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('admin.edit_user_description') }}</p>
        </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="password" name="password" id="password"
                           ...
                           placeholder="{{ __('admin.leave_blank_if_no_change') }}">
                </div>
                @error('password')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="mt-1">
                    <select name="role" id="role" required
                        ...
                        <option value="editor" {{ old('role', $user->role) === 'editor' ? 'selected' : '' }}>{{ __('admin.role_editor') }}</option>
