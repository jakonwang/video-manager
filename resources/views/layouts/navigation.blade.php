<nav class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.video-categories.index')" :active="request()->routeIs('admin.video-categories.*')">
                        {{ __('admin.categories') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.downloads.index')" :active="request()->routeIs('admin.downloads.*')">
                        {{ __('admin.downloads') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.video-categories.index')" :active="request()->routeIs('admin.video-categories.*')">
                {{ __('admin.categories') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('language.switch', 'zh')">
                    {{ __('admin.chinese') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('language.switch', 'vi')">
                    {{ __('admin.vietnamese') }}
                </x-responsive-nav-link>
